package com.hiki.springbootlearn.datasource;
...
@Configuration
@MapperScan(basePackages = "com.hiki.springbootlearn.mybatis.mapper", sqlSessionTemplateRef = "test1SqlSessionTemplate")
